# TGX Tracking API For PHP
TGX Tracking API and webhook make it easy to integrate TGX Tracking function into your own project. Support APIs Client Libraries for php

### API key

In order to use this API, you need to generate a TGX Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use TGX Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [TGX Tracking API](https://www.trackingmore.com/tgx-tracking.html)  to:

   *   Get TGX realtime tracking info of muti-carriers in one integration
   *   Provide TGX shipment tracking experience like Amazon
   *   Push TGX notifications of package update with webhook
   *   Verify TGX delivery exception before it is too late
